...
<body style="overflow-x:hidden">
  ...
  <nav class="navbar bg-dark navbar-expand-lg navbar-dark sticky-top">
    <a class="navbar-brand title" href>GOLDEN <span class="s1">HORIZON</span> BANK</a>
  ...
  <section class="section main-banner" id="top" data-section="section1">
    ...
    <div class="img-overlay header-text">
      <div class="caption">
        ...
        <h2>Banking <em>made</em> easy.</h2>
        <div class="main-button">
          <div class="scroll-to-section">
            <a href="customers.php" class="a">Transfer Money</a>
          </div>
          <br>
          <div class="scroll-to-section">
            <a href="transaction.php" class="a">Transaction History</a>
          </div>
          ...
          <div class="col-md-9 py-5">
            <div class="row">
              <div class="col-md-4 mb-md-0 mb-4">
                ...
                <ul class="about">
                  <li><a href="https://twitter.com/iam_rbn"><i class="bi bi-twitter"></i></a></li>&emsp;
                  <li><a href="https://www.linkedin.com/in/muhammedrebin/"><i class="bi bi-linkedin"></i></a></li>&emsp;
                  <li><a href="https://github.com/rebin03"><i class="bi bi-github"></i></a></li>
                </ul>
